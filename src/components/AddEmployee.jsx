  ...
  return (
    <Modal
      ...
      footer={[
        ...
        <Button key="add" size="small" type="primary" onClick={handleSubmit}>
          Add employee
        </Button>,
      ]}
      styles={{
    ...
    >
      <Form
        ...
        size="small"
        className="mt-2"
        // Overrides antd's default 24px Form.Item bottom margin
        style={{ "--ant-form-item-margin-bottom": "8px" }}
      >
        <Form.Item
          label="Employee name"
          name="name"
        ...
        <Form.Item label="Skills" style={{ marginBottom: 0 }}>
          <Select
            mode="tags"
